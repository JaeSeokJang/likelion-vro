...
def detail2(request, blog_id2):
    blog_detail2 = get_object_or_404(Qna, pk=blog_id2)
    return render(request, 'homepage/detail2.html', {'blog': blog_detail2})
...
def create(request):
    ...
    homepage.body = request.GET['body']
    homepage.pub_date = timezone.datetime.now()
    homepage.save()
    return redirect('/homepage/' + str(homepage.id))
